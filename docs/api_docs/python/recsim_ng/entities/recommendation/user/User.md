description: An abstract user entity.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="recsim_ng.entities.recommendation.user.User" />
...
# recsim_ng.entities.recommendation.user.User
...
<code>recsim_ng.entities.recommendation.user.User(
